...
import {
  ...
  fetchAds,
  fetchCategories,
  fetchMustReadArticles, // ✅ now fetching categories dynamically
} from "@/lib/contentful";
...
export default async function Home() {
  ...
  // ✅ Must Read slides
  const mustReadArticles = mustRead.map(mapEntry);
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Must Read */}
<MustReadCarousel
  articles={mustReadArticles.map((a) => ({
    id: a.id,
    title: a.title,
    href: a.href || "#",
    image: a.image,
...
/>
      ...
      <section className="my-12">
        <h2 className="text-2xl font-bold mb-6">Live from Instagram</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {instaEmbeds.map((embed, i) => (
            <InstagramEmbed key={i} embedCode={embed} />
          ))}
        </div>
      </section>
